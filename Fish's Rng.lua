...
function MakeScriptHub()
         loadstring(game:HttpGet("https://raw.githubusercontent.com/ElDonNadie820/MaxHub/refs/heads/main/Fish's%20Rng.lua",true))() --Put The Script That Will Load If The Key Is Correct Here
end
